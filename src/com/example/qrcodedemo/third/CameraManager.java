...
public final class CameraManager {
	...
	private static final int MAX_FRAME_WIDTH = 640; // = 5/8 * 1920
	private static final int MAX_FRAME_HEIGHT = 640; // = 5/8 * 1080
	 ...
	 * will be in focus. 计算这个条形码的扫描框；便于声明的同时，也强制用户�?�过改变距离来扫描到整个条形�?
	 * 
